...
async function cargarClientes() {
    try {
        ...
        // Si viene preseleccionado desde ventas
    ...
    input.addEventListener("input", () => {
        ...
        resultados.innerHTML = filtrados.length === 0
            ...
            : filtrados.slice(0,8).map(c => `
                <div class="cliente-result-item" onclick="seleccionarCliente(${c.id_cliente})">
...
function renderCarrito() {
    ...
    if (sidebarBadge) {
        ...
        sidebarBadge.style.display  = totalItems > 0 ? "inline-flex" : "none";
    }
    ...
    carrito.forEach(p => {
        ...
        tr.innerHTML = `
            <td>
                ...
                ${p.desde_orden ? `<div style="font-size:.68rem;color:#d97706;font-weight:600">📋 Desde orden #${p.desde_orden}</div>` : ""}
            </td>
            <td>
